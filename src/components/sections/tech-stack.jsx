                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                        {Array.from({ length: 8 }).map((_, index) => (
                            <div key={index} className="animate-pulse">
                                <div className="bg-gray-300 dark:bg-gray-700 h-32 rounded-lg" />
                            </div>
                        ))}
                    </div>
                ) : (
                    ...
                    <div className="glassmorphism rounded-xl p-8 max-w-4xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="flex items-center space-x-4">
                                <img
                                    src="https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?auto=format&fit=crop&w=300&h=200"
                                ...
                                <div className="text-left">
                                    ...
                                    <p className="text-sm text-gray-300">
                                        Mobile-first development with powerful
                            ...
                            <div className="flex items-center space-x-4">
                                <img
                                    src="https://images.unsplash.com/photo-1518709268805-4e9042af2176?auto=format&fit=crop&w=300&h=200"
                                ...
                                <div className="text-left">
                                    ...
                                    <p className="text-sm text-gray-300">
                                        Full Linux environment for mobile
